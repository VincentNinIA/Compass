...
les `POST /api/*` à 6 par minute et par IP. La Production sert toujours T18;
T24-C03 est active : `95e9933` est READY mais non qualifié après détection d'un
contraste de checklist professeur; son descendant corrigé doit être redéployé
et qualifier l'alias T22 protégé avant toute ouverture de T25.
...
| T24-C03 | active | T24-C02 | Artefact T22 exact déployé et parcours public qualifié |
